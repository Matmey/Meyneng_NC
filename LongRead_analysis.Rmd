...
phylo_rar <- readRDS("~/Desktop/Article/2025/Long Reads New_caledonia/Long_Reads_Fungi/rawdata/phylo_rar.rds")
...
write.table(OTUs_of_interest,file="result/subset_CCs_thio_list.txt",col.names = FALSE, row.names = FALSE,quote = FALSE)
```
